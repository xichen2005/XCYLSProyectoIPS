...
namespace UPM_IPS.XCYLSProyectoIPS
{
	...
	/// ConnectionBuilder class to provide logic for constructing connections between elements.
	/// </summary>
	public static partial class AtributoReferencesEstiloCampoFormulariosBuilder
	{
		#region Accept Connection Methods
		/// <summary>
		/// Test whether a given model element is acceptable to this ConnectionBuilder as the source of a connection.
			...
			else // Check combinations
			{
				if (candidateSource is global::UPM_IPS.XCYLSProyectoIPS.Atributo)
				{
					if (candidateTarget is global::UPM_IPS.XCYLSProyectoIPS.EstiloCampoFormulario)
					{
						...
						if(targetEstiloCampoFormulario == null || sourceAtributo == null || global::UPM_IPS.XCYLSProyectoIPS.AtributoReferencesEstiloCampoFormularios.GetLinks(sourceAtributo, targetEstiloCampoFormulario).Count > 0) return false;
						return true;
					}
				}
			...
			if (CanAcceptSourceAndTarget(source, target))
			{
				if (source is global::UPM_IPS.XCYLSProyectoIPS.Atributo)
				{
					if (target is global::UPM_IPS.XCYLSProyectoIPS.EstiloCampoFormulario)
					{
						...
						DslModeling::ElementLink result = new global::UPM_IPS.XCYLSProyectoIPS.AtributoReferencesEstiloCampoFormularios(sourceAccepted, targetAccepted);
						if (DslModeling::DomainClassInfo.HasNameProperty(result))
						{
							DslModeling::DomainClassInfo.SetUniqueName(result);
						}
	...
	/// Handles interaction between the ConnectionBuilder and the corresponding ConnectionTool.
	/// </summary>
	internal partial class EnlaceAtr_EstiloCConnectAction : DslDiagrams::ConnectAction
	{
		private DslDiagrams::ConnectionType[] connectionTypes;
		
		/// <summary>
		/// Constructs a new EnlaceAtr_EstiloCConnectAction for the given Diagram.
		/// </summary>
		public EnlaceAtr_EstiloCConnectAction(DslDiagrams::Diagram diagram): base(diagram, true) 
		{
		}
		...
		/// <summary>
		/// Returns the EnlaceAtr_EstiloCConnectionType associated with this action.
		/// </summary>
		protected override DslDiagrams::ConnectionType[] GetConnectionTypes(DslDiagrams::ShapeElement sourceShapeElement, DslDiagrams::ShapeElement targetShapeElement)
		{
			if(this.connectionTypes == null)
			{
				this.connectionTypes = new DslDiagrams::ConnectionType[] { new EnlaceAtr_EstiloCConnectionType() };
			}
			
			return this.connectionTypes;
		}
		
		private partial class EnlaceAtr_EstiloCConnectionTypeBase : DslDiagrams::ConnectionType
		{
			/// <summary>
			/// Constructs a new the EnlaceAtr_EstiloCConnectionType with the given ConnectionBuilder.
			/// </summary>
			protected EnlaceAtr_EstiloCConnectionTypeBase() : base() {}
			...
			/// </summary>
			/// <remarks>
			/// This implementation delegates calls to the ConnectionBuilder AtributoReferencesEstiloCampoFormulariosBuilder.
			/// </remarks>
			public override bool CanCreateConnection(DslDiagrams::ShapeElement sourceShapeElement, DslDiagrams::ShapeElement targetShapeElement, ref string connectionWarning)
			{
				bool canConnect = true;
				...
				{				
					if(targetShapeElement == null)
					{
						return AtributoReferencesEstiloCampoFormulariosBuilder.CanAcceptSource(sourceElement);
					}
					else
					{				
						return AtributoReferencesEstiloCampoFormulariosBuilder.CanAcceptSourceAndTarget(sourceElement, targetElement);
					}
				}
				else
				{
			...
			public override void CreateConnection(DslDiagrams::ShapeElement sourceShapeElement, DslDiagrams::ShapeElement targetShapeElement, DslDiagrams::PaintFeedbackArgs paintFeedbackArgs)
			{
				...
				DslModeling::ModelElement targetElement = targetShapeElement.ModelElement;
				if(targetElement == null) targetElement = targetShapeElement;
				AtributoReferencesEstiloCampoFormulariosBuilder.Connect(sourceElement, targetElement);
			}
		}
		
		private partial class EnlaceAtr_EstiloCConnectionType : EnlaceAtr_EstiloCConnectionTypeBase
		{
			/// <summary>
			/// Constructs a new the EnlaceAtr_EstiloCConnectionType with the given ConnectionBuilder.
			/// </summary>
			public EnlaceAtr_EstiloCConnectionType() : base() {}
		}
	}
}
