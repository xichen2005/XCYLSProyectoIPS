...
namespace UPM_IPS.XCYLSProyectoIPS
{
	...
	/// </remarks>
	public partial class XCYLSProyectoIPSHelpKeywordHelper : XCYLSProyectoIPSHelpKeywordHelperBase 
	{
		
		/// <summary>
		/// Constructs a new XCYLSProyectoIPSHelpKeywordHelper.
		/// </summary>
		protected XCYLSProyectoIPSHelpKeywordHelper()
			: base() { }
			
		/// <summary>
		/// Single instance of the XCYLSProyectoIPSHelpKeywordHelper.
		/// </summary>
		public static XCYLSProyectoIPSHelpKeywordHelper Instance
		{
			get
			{
	...
	/// </summary>
	public abstract class XCYLSProyectoIPSHelpKeywordHelperBase
	{
		private global::System.Collections.Generic.Dictionary<string, string> helpKeywords;
		
		/// <summary>
		/// Constructs a new XCYLSProyectoIPSHelpKeywordHelperBase.
		/// </summary>
		protected XCYLSProyectoIPSHelpKeywordHelperBase()
			: base() { }
