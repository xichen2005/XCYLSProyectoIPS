...
namespace UPM_IPS.XCYLSProyectoIPS
{
	...
	/// </summary>
	internal partial class XCYLSProyectoIPSCommandSet : XCYLSProyectoIPSCommandSetBase
	{
		/// <summary>
		/// Constructs a new XCYLSProyectoIPSCommandSet.
		/// </summary>
		public XCYLSProyectoIPSCommandSet(global::System.IServiceProvider serviceProvider) 
	...
	/// </summary>
	internal abstract class XCYLSProyectoIPSCommandSetBase : DslShell::CommandSet
	{
		/// <summary>
		/// Constructs a new XCYLSProyectoIPSCommandSetBase.
		/// </summary>
		protected XCYLSProyectoIPSCommandSetBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		protected override global::System.Collections.Generic.IList<global::System.ComponentModel.Design.MenuCommand> GetMenuCommands()
		{
			...
			menuCommand = new DslShell::CommandContextBoundMenuCommand(this.ServiceProvider,
				...
				Constants.ViewXCYLSProyectoIPSExplorerCommand,
				typeof(XCYLSProyectoIPSEditorFactory).GUID);
		...
		{
			XCYLSProyectoIPSExplorerToolWindow explorer = this.XCYLSProyectoIPSExplorerToolWindow;
			if (explorer != null)
			{
				explorer.Show();
			}
		...
		protected XCYLSProyectoIPSDocData CurrentXCYLSProyectoIPSDocData
		{
			get
			{
				return this.MonitorSelection.CurrentDocument as XCYLSProyectoIPSDocData;
			}
		}
		...
		/// </summary>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode")]
		protected XCYLSProyectoIPSDocView CurrentXCYLSProyectoIPSDocView
		{
			get
			{
				return this.MonitorSelection.CurrentDocumentView as XCYLSProyectoIPSDocView;
			}
		}
		...
		/// </summary>
		protected XCYLSProyectoIPSExplorerToolWindow XCYLSProyectoIPSExplorerToolWindow
		{
			get
			{
				XCYLSProyectoIPSExplorerToolWindow explorerWindow = null;
				...
				if (package != null)
				{
					explorerWindow = package.GetToolWindow(typeof(XCYLSProyectoIPSExplorerToolWindow), true) as XCYLSProyectoIPSExplorerToolWindow;
				}
		...
		protected object ExplorerSelection
		{
			get
			{
				...
				XCYLSProyectoIPSExplorerToolWindow explorerWindow = this.XCYLSProyectoIPSExplorerToolWindow;
	...
	/// Double-derived class to allow easier code customization.
	/// </summary>
	internal partial class XCYLSProyectoIPSClipboardCommandSet : XCYLSProyectoIPSClipboardCommandSetBase
	{
		/// <summary>
		/// Constructs a new XCYLSProyectoIPSClipboardCommandSet.
		/// </summary>
		public XCYLSProyectoIPSClipboardCommandSet(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
	}
	...
	/// </summary>
	internal abstract partial class XCYLSProyectoIPSClipboardCommandSetBase : DslShell::ClipboardCommandSet
	{
		/// <summary>
		/// Constructs a new XCYLSProyectoIPSClipboardCommandSetBase.
		/// </summary>
		protected XCYLSProyectoIPSClipboardCommandSetBase(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
